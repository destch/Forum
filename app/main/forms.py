...
class ThreadForm(FlaskForm):
    ...
    scene = SelectField(u'Post to Scene (Optional)', choices=[('', ''), ('Los Angeles', 'Los Angeles'), ('NYC', 'NYC'), ('Chicago', 'Chicago')])
    type = 'thread'
...
class LinkForm(FlaskForm):
    ...
    scene = QuerySelectField('Post to a Scene (Optional)', query_factory=lambda: Scene.query.all(),
...
class SceneForm(FlaskForm):
    ...
    description = TextAreaField('Description', render_kw={'class': 'form-control', 'rows': 2})
